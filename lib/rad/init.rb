...
%w(generators/makefile/makefile.rb rad_processor.rb rad_rewriter.rb rad_type_checker.rb variable_processing.rb arduino_sketch.rb arduino_plugin.rb arduino_hardware_config.rb tasks/rad.rb sketch_compiler.rb).each do |path|
